...
# Geometry of the GUI
root.geometry("291x287")
root.title("Calculator")

text_result = tk.Text(root, height=2, width=16, font=("Arial", 24), bg="black", foreground= "white")
...
btn_multi = tk.Button(root, text="*", command= lambda: add_to_calculation("*"), width=5, font=("Arial", 16))
...
# Clear
btn_clear = tk.Button(root, text="AC", command= clear_field, width=11, font=("Arial", 16))
